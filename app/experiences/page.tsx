...
export const metadata = {
  title: "Experiences | Andean Luxury Resort"
};
  ...
  return (
    <main className="px-5 pt-32 md:px-8">
      <AnimatedSection className="mx-auto max-w-7xl">
        <SectionHeading
          eyebrow="Experiences"
          title="A richer revenue layer for every stay."
          copy="Interactive experience cards give owners a clear vision for pre-arrival upsells, concierge workflows, and unforgettable itineraries."
        />
      </AnimatedSection>
        ...
        {experiences.map((experience) => (
          <AnimatedSection key={experience.title} className="group relative min-h-[520px] overflow-hidden rounded-sm">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 md:p-8">
              <p className="inline-flex items-center gap-2 bg-black/45 px-3 py-2 text-xs uppercase tracking-[0.22em] text-[#d7b56d] backdrop-blur">
              ...
              <Button href="/concierge" variant="ghost" className="mt-6"><Compass size={17} /> Ask Concierge</Button>
            </div>
          </AnimatedSection>
        ))}
      </div>
